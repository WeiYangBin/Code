...
class EMN(object):
        ...
        with tf.variable_scope('memory'):
            ...
            with tf.variable_scope('episodic_appear') as scope:
                ...
                for p in range(3):
                    ...
                    episode = tf.reduce_sum(tf.expand_dims(attention(memory_appear, bool(p)), 2) * u1, 2)
            ...
            with tf.variable_scope('episodic_motion') as scope:
                ...
                for p in range(3):
                    episode = tf.reduce_sum(tf.expand_dims(attention(memory_motion, bool(p)), 2) * u1, 2)
                    episode = tf.reshape(episode, [-1, 20 * self.memory_dim])
    ...
    def build_train(self, learning_rate):
        ...
        with tf.variable_scope('train'):
            ...
            warm_up_steps = 510    #msvd = 190    msrvtt = 510
